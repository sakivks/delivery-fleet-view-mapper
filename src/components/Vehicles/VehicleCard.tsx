...
const VehicleCard = ({ vehicle, onClick }: VehicleCardProps) => {
  const completionPercentage = Math.round(
    (vehicle.deliveries.completed / vehicle.deliveries.total) * 100
  );
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1">
            <div className="flex justify-between">
              ...
              {vehicle.id === "364448f2-a54d-4114-9f1a-963be4fd33b4" ? (
                <div className="text-[14px] text-red-500">Delayed by 3hr</div>
              ) : null}
              <div
              ...
              <div>
                <div className="flex justify-between mb-1 text-xs">
                  <span className="text-gray-600">
                    {vehicle.deliveries.completed} of {vehicle.deliveries.total}
                  </span>
